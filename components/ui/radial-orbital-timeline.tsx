  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          {/* Rotating Text Ring - Smaller container (160px), corrected spacing and radius */}
          <div className="absolute w-[160px] h-[160px] z-0 animate-[spin_12s_linear_infinite_reverse] opacity-50">
            <svg viewBox="0 0 100 100" width="100%" height="100%" className="overflow-visible">
              ...
              <text fontSize="8" fill="white" letterSpacing="3px" fontWeight="bold">
                {/* 
                   Circumference = 2 * PI * 44 ≈ 276.
                   textLength ensures the text is distributed evenly around the circle.
                */}
                <textPath xlinkHref="#circlePath" textLength="276">
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      <div className="pt-3 border-t border-white/10">
                        <div className="flex justify-between items-center text-xs mb-1">
                          ...
                          <span className="font-mono">{item.energy}/100</span>
                        </div>
