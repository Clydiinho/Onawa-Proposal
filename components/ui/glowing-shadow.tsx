...
export function GlowingShadow({ children, className, style, onClick }: GlowingShadowButtonProps) {
  return (
    <>
      <style>{`
        @property --hue {
        ...
        .glow-container {
          ...
          /* removed aspect-ratio specific constraints for flexibility */
          height: auto;
          color: white;
          margin: 0;
          display: flex;
      ...
      <div 
        className={cn("glow-container", className)} 
        style={style} 
        role="button"
        onClick={onClick}
      >
